...
Pour comprendre comment le projet est construit et comment y contribuer (spécialement si vous utilisez une IA), merci de vous référer aux fichiers suivants :
