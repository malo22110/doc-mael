      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildOption("0 - 2 personnes", "0-2", Colors.green),
            const SizedBox(height: 24),
            _buildOption("3 - 5 personnes", "3-5", Colors.lightGreen),
            const SizedBox(height: 24),
            _buildOption("6 - 9 personnes", "6-9", Colors.orange),
            const SizedBox(height: 24),
            _buildOption("10+ personnes", "10+", Colors.red),
          ],
        ),
      ),
    );
